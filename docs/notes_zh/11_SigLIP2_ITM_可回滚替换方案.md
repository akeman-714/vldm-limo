...
```bash
# 默认:SigLIP2-base ITM(独立 siglip2_itm env,本机优先用 /home/asong/siglip2-base-patch16-384)
...
- 本地模型:`/home/asong/siglip2-base-patch16-384`
- 已确认模型文件:
  - `config.json`
...
- 完整 cat_demo 单集成功:
  - video:`/home/asong/vlfm/outputs/siglip2_cat_full_habgpu1_20260614_165653/video/episode=0-ckpt=0-distance_to_goal=0.30-success=1.00-spl=0.39-soft_spl=0.38-distance_to_goal_reward=-0.00-traveled_stairs=0.00-yaw=-120.00-target_detected=1.00-stop_called=1.00-start_yaw=2.06.mp4`
  - `success=1.0000`
...
CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. \
  ...
  --mode torch-ref \
  --model-id /home/asong/siglip2-base-patch16-384 \
...
itm = SigLIP2ITM(model_id="/home/asong/siglip2-base-patch16-384")
