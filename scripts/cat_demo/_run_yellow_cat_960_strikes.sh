...
export VIDEO_DIR="${VIDEO_DIR:-/home/asong/vlfm/video_dir/yellow_cat_960_strikes_${TS}}"
export LOG="${LOG:-/home/asong/vlfm/outputs/yellow_cat_960_strikes_${TS}.log}"
export TB_DIR="${TB_DIR:-/home/asong/vlfm/tb/yellow_cat_960_strikes_${TS}}"
